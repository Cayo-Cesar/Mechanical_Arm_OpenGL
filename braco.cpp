...
void keyboard (unsigned char key, int x, int y){
	switch (key) {
        ...
        case 'i': indicador = (indicador + 5) % 360; break; // sentido anti-horário
        case 'I': indicador = (indicador - 5) % 360; break; // sentido horario
 	    case 'p': polegar = (polegar + 5) % 360; break; // sentido anti-horário
        case 'P': polegar = (polegar - 5) % 360; break; // sentido horario
  	    case 'a': anelar = (anelar + 5) % 360; break; // sentido anti-horário
...
// Polegar
glPushMatrix();
    glTranslatef(-0.5, 1.0, 0.0); // Posição inicial do polegar em relação ao antebraço
    glRotatef((GLfloat) polegar, 1.0, 0.0, 0.0); // Rotação do polegar em torno do próprio eixo
...
// Anelar
glPushMatrix();
    glTranslatef(-0.5, 1.0, 0.0); // Posição inicial do anelar em relação ao antebraço
    glRotatef((GLfloat) anelar, 1.0, 0.0, 0.0); // Rotação do anelar em torno do próprio eixo
...
// Indicador
glPushMatrix();
    glTranslatef(-0.5, 1.0, 0.0); // Posição inicial do indicador em relação ao antebraço
    glRotatef((GLfloat) indicador, 1.0, 0.0, 0.0); // Rotação do indicador em torno do próprio eixo
